...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_dinosaurs
    ...
    notasaurus = []
    animals.each do |x|
      notasaurus << x unless x[-5..-1] == "aurus"
    end
  ...
  def test_remove_numbers
    ...
    not_numbers = []
    elements.each do |x|
      not_numbers << x if x.class == String
    end
  ...
  def test_remove_floats
    ...
    not_numbers = []
    elements.each do |x|
      not_numbers << x if x.class != Float
    end
  ...
  def test_remove_arrays
    ...
    remaining = []
    elements.each do |x|
      remaining << x unless x.class == Array
    end
  ...
  def test_remove_hashes
    ...
    remaining = []
    elements.each do |x|
      remaining << x unless x.class == Hash
    end
